...
public class Colaboracion {
	...
	public String toString() {
        return "Colaboracion" ["ideColaboraciones="+ idColaboraciones, "nombre="+ nombre, "direccion="+ direccion, "telefono="+ telefono, "apellidos=" +apellidos, "metodo="+ metodo, "email=" + email, "cantidad="+cantidad]
